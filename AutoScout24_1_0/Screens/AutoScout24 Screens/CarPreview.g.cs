...
namespace AutoScout24_Model.Screens.AutoScout24Screens
{
    ...
    public partial class CarPreview : Progile.TRIO.BaseModel.BaseScreen
    {
        public CarPreview(AutoScout24App app) : base(app, @"Car Preview", Images.AutoScout24Screens.CarPreview.Screen_Loaded)
        {
            ...
            Gearbox = new Progile.TRIO.BaseModel.LabelWithValue(appBasics: AppBasics, displayName: "Gearbox", valuePosition: RelativePosition.Right, imageReferenceForLabel: Images.AutoScout24Screens.CarPreview.Gearbox, gridWidth: 120, filters: ScreenSelect) { ParentElement = this };
            FirstRegistration = new Progile.TRIO.BaseModel.LabelWithValue(appBasics: AppBasics, displayName: "First Registration", valuePosition: RelativePosition.Right, imageReferenceForLabel: Images.AutoScout24Screens.CarPreview.FirstRegistration, gridWidth: 120, filters: ScreenSelect) { ParentElement = this };
            ...
            Power = new Progile.TRIO.BaseModel.LabelWithValue(appBasics: AppBasics, displayName: "Power", valuePosition: RelativePosition.Right, imageReferenceForLabel: Images.AutoScout24Screens.CarPreview.Power, gridWidth: 120, filters: ScreenSelect) { ParentElement = this };
