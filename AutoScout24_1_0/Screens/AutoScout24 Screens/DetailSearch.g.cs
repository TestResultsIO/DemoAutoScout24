...
namespace AutoScout24_Model.Screens.AutoScout24Screens
{
    ...
    public partial class DetailSearch : Progile.TRIO.BaseModel.BaseScreen
    {
        public DetailSearch(AutoScout24App app) : base(app, @"Detail Search", Images.AutoScout24Screens.DetailSearch.Screen_Loaded)
        {
            ...
            AdditionalProperties = new Progile.TRIO.BaseModel.TextBox(appBasics: AppBasics, displayName: "Additional Properties", imageReference: Images.AutoScout24Screens.DetailSearch.VariantTextbox, useVisualSense: true, filters: ScreenSelect) { ParentElement = this };
        ...
        public Progile.TRIO.BaseModel.TextBox AdditionalProperties { get; private set; }
