...
namespace AutoScout24_Model.Screens.AutoScout24Screens
{
    ...
    public partial class DetailSearch : Progile.TRIO.BaseModel.BaseScreen
    {
        ...
        {
            App = app;
            MakeDropdownWithSearchbox = new AutoScout24_Model.CustomScreenElements.DropdownWithSearchbox(appBasics: AppBasics, displayName: "Make DropdownWithSearchbox", imageReference: Images.AutoScout24Screens.DetailSearch.MakeDropdown.DropdownTextBox, useVisualSense: false, filters: ScreenSelect) { ParentElement = this };
            ModelDropdownWithSearchbox = new AutoScout24_Model.CustomScreenElements.DropdownWithSearchbox(appBasics: AppBasics, displayName: "Model DropdownWithSearchbox", imageReference: Images.AutoScout24Screens.DetailSearch.ModelDropdown.DropdownTextBox, useVisualSense: false, filters: ScreenSelect) { ParentElement = this };
