...
namespace AutoScout24_Model.Screens.TruckScout24Screens.SellWorkflow
{
    ...
    public partial class VehicleType : Progile.TRIO.BaseModel.BaseScreen
    {
        ...
        {
            App = app;
            AgriculturalMachines = new Progile.TRIO.BaseModel.Button(appBasics: AppBasics, displayName: "Agricultural machines", activeImageReference: Images.TruckScout24Screens.SellWorkflow.VehicleType.AgriculturalMachines.active, useVisualSense: false, filters: ScreenSelect) { ParentElement = this };
