...
namespace AutoScout24_Model.Screens
{
    ...
    {
        public MainPage(IAppBasics appBasics) : base(appBasics, @"Main Page", Images.MainPage.Screen_Loaded)
        {
            RefineSearchLink = new Progile.TRIO.BaseModel.Button(tester: t, displayName: "Refine search Link", activeImageReference: Images.MainPage.RefineSearchLink.active, useVisualSense: false, filters: ScreenSelect) { ParentElement = this };
